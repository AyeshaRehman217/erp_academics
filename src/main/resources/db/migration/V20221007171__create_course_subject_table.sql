...
(
    ...
    theory_credit_hours character varying,
    practical_credit_hours character varying,
    elective_subject boolean DEFAULT false,
    obe boolean DEFAULT false,
    total_credit_hours integer,
    lecture_type_uuid uuid,
--     core_subject boolean DEFAULT false,
--     prerequisite boolean DEFAULT false,
--     deficiency_subject boolean DEFAULT false,
