CREATE TABLE public.std_profiles
(
    ...
    student_uuid uuid,
--  image uuid will be from Drive Module
    image uuid,
...
--  City will be from Config Module
    city_uuid uuid,
--  State will be from Config Module
    state_uuid uuid,
--  Country will be from Config Module
    country_uuid uuid,
    religion_uuid uuid,
    sect_uuid uuid,
    caste_uuid uuid,
    gender_uuid uuid,
    marital_status_uuid uuid,
