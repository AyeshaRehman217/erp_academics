CREATE TABLE public.std_sibling_profiles
(
    ...
    std_sibling_uuid uuid,
--  image will be Doc Id from Drive Module
    image uuid,
    age integer,
    nic character varying,
    -- State,Country and City Id will be used from Config Module
    city_uuid uuid,
    state_uuid uuid,
    country_uuid uuid,
