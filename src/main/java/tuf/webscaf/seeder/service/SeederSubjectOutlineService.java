...
@Service
public class SeederSubjectOutlineService {
    ...
    public Mono<ServerResponse> seedSubjectOutline() {
        ...
        formData.add("courseSubjectUUID", "73fd483f-0a86-44c2-83b3-5b3ed269c84d");
        ...
        for (MultiValueMap<String, String> valueMap : formDataList) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI + "api/v1/subject-outlines/store", valueMap);
