...
@Service
public class SeederHobbyService {
    ...
    public Mono<ServerResponse> seedHobby(){
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/hobbies/store", formDataList.get(i));
