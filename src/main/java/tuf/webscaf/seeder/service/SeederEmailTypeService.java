...
@Service
public class SeederEmailTypeService {
    @Autowired
    ...
    public Mono<ServerResponse> seedEmailType(){

        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();

        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Official Email");
        formData.add("description", "This is Official Email");
        formData.add("status", "true");

        MultiValueMap<String, String> formData1 = new LinkedMultiValueMap<>();
        formData1.add("name", "Personal Email");
        formData1.add("description", "This is Personal Email");
        formData1.add("status", "true");

        MultiValueMap<String, String> formData2 = new LinkedMultiValueMap<>();
        formData2.add("name", "Other Email");
        formData2.add("description", "This is Other Email");
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/email-types/store", formDataList.get(i));
