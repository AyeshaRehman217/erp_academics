...
@Service
public class SeederSessionService {
    ...
    public Mono<ServerResponse> seedSession(){

        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();

        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Fall");
        formData.add("description", "This is a Fall session");
        formData.add("status", "true");

        MultiValueMap<String, String> formData1 = new LinkedMultiValueMap<>();
        formData1.add("name", "Spring");
        formData1.add("description", "This is a Spring Session");
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/sessions/store", formDataList.get(i));
