...
@Service
public class SeederSubjectOfferedService {
    ...
    @Autowired
    private SlaveAcademicSessionRepository slaveAcademicSessionRepository;

    @Autowired
    private SlaveCourseSubjectRepository slaveCourseSubjectRepository;

    public Mono<ServerResponse> seedSubjectOffered() {
        ...
        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();
                    ...
                    for (MultiValueMap<String, String> valueMap : formDataList) {
                        Mono<Boolean> res = seederService
                                .seedData(academicBaseURI + "api/v1/subject-offered/store", valueMap);
