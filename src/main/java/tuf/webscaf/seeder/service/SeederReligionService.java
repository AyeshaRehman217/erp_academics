...
@Service
public class SeederReligionService {
    ...
    public Mono<ServerResponse> seedReligion(){

        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();

        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Islam");
        formData.add("description", "This is a religion");
        formData.add("status", "true");

        MultiValueMap<String, String> formData1 = new LinkedMultiValueMap<>();
        formData1.add("name", "Christianity");
        formData1.add("description", "This is a religion");
        formData1.add("status", "true");

        MultiValueMap<String, String> formData2 = new LinkedMultiValueMap<>();
        formData2.add("name", "Hinduism");
        formData2.add("description", "This is a religion");
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/religions/store", formDataList.get(i));
