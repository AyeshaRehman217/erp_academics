...
@Service
public class SeederCasteService {
    ...
    public Mono<ServerResponse> seedCaste(){
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/castes/store", formDataList.get(i));
