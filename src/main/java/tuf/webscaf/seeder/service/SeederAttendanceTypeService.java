...
@Service
public class SeederAttendanceTypeService {
    ...
    public Mono<ServerResponse> seedAttendanceType(){

        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();

        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Present");
        formData.add("description", "This is a present attendance type");
        formData.add("status", "true");

        MultiValueMap<String, String> formData1 = new LinkedMultiValueMap<>();
        formData1.add("name", "Absent");
        formData1.add("description", "This is a absent attendance type");
        formData1.add("status", "true");

        MultiValueMap<String, String> formData2 = new LinkedMultiValueMap<>();
        formData2.add("name", "Leave");
        formData2.add("description", "This is a leave attendance type");
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/attendance-types/store", formDataList.get(i));
