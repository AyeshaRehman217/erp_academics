...
@Service
public class SeederCourseLevelService {
    ...
    public Mono<ServerResponse> seedCourseLevel(){

        List<MultiValueMap<String, String>> formDataList = new ArrayList<>();

        MultiValueMap<String, String> formData = new LinkedMultiValueMap<>();
        formData.add("name", "Primary Education");
        formData.add("description", "Primary Education");
        formData.add("status", "true");

        MultiValueMap<String, String> formData1 = new LinkedMultiValueMap<>();
        formData1.add("name", "Secondary Education");
        formData1.add("description", "Secondary Education");
        formData1.add("status", "true");

        MultiValueMap<String, String> formData2 = new LinkedMultiValueMap<>();
        formData2.add("name", "Intermediate Education");
        formData2.add("description", "Intermediate Education");
        formData2.add("status", "true");

        MultiValueMap<String, String> formData3 = new LinkedMultiValueMap<>();
        formData3.add("name", "Bachelors degree");
        formData3.add("description", " Bachelors degree");
        formData3.add("status", "true");

        MultiValueMap<String, String> formData4 = new LinkedMultiValueMap<>();
        formData4.add("name", "Masters degree");
        formData4.add("description", "Masters degree");
        formData4.add("status", "true");

        MultiValueMap<String, String> formData5 = new LinkedMultiValueMap<>();
        formData5.add("name", "Doctoral degree");
        formData5.add("description", "Doctoral degree");
        ...
        for (int i = 0; i < formDataList.size(); i++) {
            Mono<Boolean> res = seederService
                    .seedData(academicBaseURI+"api/v1/course-levels/store", formDataList.get(i));
