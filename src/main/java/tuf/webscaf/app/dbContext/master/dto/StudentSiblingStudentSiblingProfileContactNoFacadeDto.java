...
@NoArgsConstructor
@AllArgsConstructor
public class StudentSiblingStudentSiblingProfileContactNoFacadeDto {
    ...
    @Schema(description = "*optional- student uuid of student sibling")
    private UUID studentSiblingAsStudentUUID;

    @Schema(hidden = true)
    private UUID studentSiblingUUID;
    ...
    @Schema(required = true)
    private List<StudentContactNoDto> studentSiblingContactNoDto;
