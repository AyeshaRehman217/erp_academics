...
@NoArgsConstructor
@AllArgsConstructor
public class TeacherSpouseTeacherSpouseProfileContactNoFacadeDto {
    ...
    @Schema(description = "*optional- student uuid of teacher spouse")
    private UUID studentUUID;

    @Schema(description = "*optional- teacher uuid of teacher spouse")
    private UUID teacherSpouseAsTeacherUUID;
    ...
    @Schema(required = true)
    private List<TeacherContactNoDto> teacherSpouseContactNoDto;
