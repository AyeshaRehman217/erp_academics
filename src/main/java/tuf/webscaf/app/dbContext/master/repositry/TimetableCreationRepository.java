...
@Repository
public interface TimetableCreationRepository extends ReactiveCrudRepository<TimetableCreationEntity, Long> {

    Mono<TimetableCreationEntity> findByIdAndDeletedAtIsNull(Long id);

    Mono<TimetableCreationEntity> findByUuidAndDeletedAtIsNull(UUID uuid);

    Mono<TimetableCreationEntity> findFirstBySectionUUIDAndDeletedAtIsNull(UUID sectionUUID);

    Mono<TimetableCreationEntity> findFirstByEnrollmentUUIDAndDeletedAtIsNull(UUID enrollmentUUID);

    Mono<TimetableCreationEntity> findFirstByDayUUIDAndDeletedAtIsNull(UUID dayUUID);

    Mono<TimetableCreationEntity> findFirstByClassroomUUIDAndDeletedAtIsNull(UUID classroomUUID);

    Mono<TimetableCreationEntity> findFirstByTeacherUUIDAndDeletedAtIsNull(UUID teacherUUID);
    ...
    @Query("SELECT timetable_creations.* \n" +
            ...
            "WHERE (timetable_creations.day = :day) \n" +
