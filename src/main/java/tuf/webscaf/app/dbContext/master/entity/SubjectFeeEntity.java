...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"subject_fees\"")
public class SubjectFeeEntity {
    ...
    @Column("subject_offered_uuid")
    @Schema(required = true)
    private UUID subjectOfferedUUID;

    @Column("credit_hours_rate")
    private Double creditHoursRate;

    @Column("subject_enrollment_fee")
    @Schema(required = true)
    private Double subjectEnrollmentFee;
    ...
    @Column("is_amount")
    @Schema(required = true, description = "If its true user then user will be able to add Amount Only and Credit Hour Rate will be hidden")
