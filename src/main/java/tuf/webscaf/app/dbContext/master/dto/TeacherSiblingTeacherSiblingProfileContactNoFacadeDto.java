...
@NoArgsConstructor
@AllArgsConstructor
public class TeacherSiblingTeacherSiblingProfileContactNoFacadeDto {
    ...
    @Schema(description = "*optional- student uuid of teacher sibling")
    private UUID studentUUID;

    @Schema(hidden = true)
    private UUID teacherSiblingUUID;
    ...
    @Schema(required = true)
    private List<TeacherContactNoDto> teacherSiblingContactNoDto;
