...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"timetable_details\"")
public class TimetableDetailEntity {
    ...
    @Column("timetable_uuid")
    @Schema(required = true)
    private UUID timetableUUID;

    @Column("calendar_date_uuid")
    @Schema(required = true, description = "This is calendar date uuid from config module")
    private UUID calendarDateUUID;
