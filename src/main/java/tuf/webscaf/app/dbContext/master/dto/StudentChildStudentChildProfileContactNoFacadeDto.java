...
@NoArgsConstructor
@AllArgsConstructor
public class StudentChildStudentChildProfileContactNoFacadeDto {
    ...
    @Schema(description = "*optional- student uuid of student child")
    private UUID studentChildAsStudentUUID;

    @Schema(hidden = true)
    private UUID studentChildUUID;
    ...
    @Schema(required = true)
    private List<StudentContactNoDto> studentChildContactNoDto;
