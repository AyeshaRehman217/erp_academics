...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"notification_details\"")
public class NotificationDetailEntity {
    ...
    @Column("signed_by")
    @Schema(required = true, description = "This is user uuid from authentication module")
    private UUID signedBy;

    @Column("received_from")
    @Schema(required = true, description = "This is department uuid from config module")
