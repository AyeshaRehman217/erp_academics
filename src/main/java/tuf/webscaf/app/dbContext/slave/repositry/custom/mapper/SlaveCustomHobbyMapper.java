...
public class SlaveCustomHobbyMapper implements BiFunction<Row, Object, SlaveHobbyEntity> {
    @Override
    public SlaveHobbyEntity apply(Row source, Object o) {
        return SlaveHobbyEntity.builder()
