...
public class SlaveCustomCampusCourseMapper implements BiFunction<Row, Object, SlaveCampusCourseDto> {
    @Override
    public SlaveCampusCourseDto apply(Row source, Object o) {
        return SlaveCampusCourseDto.builder()
