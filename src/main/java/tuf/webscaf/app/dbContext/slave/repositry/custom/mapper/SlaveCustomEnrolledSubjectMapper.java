...
public class SlaveCustomEnrolledSubjectMapper implements BiFunction<Row, Object, SlaveEnrolledSubjectDto> {
    @Override
    public SlaveEnrolledSubjectDto apply(Row source, Object o) {
        return SlaveEnrolledSubjectDto.builder()
                ...
                .courseCode(source.get("courseCode", String.class))
                .semesterName(source.get("semesterName", String.class))
                .semesterNo(source.get("semesterNo", String.class))
                .totalCreditHours(source.get("totalCreditHours", Integer.class))
