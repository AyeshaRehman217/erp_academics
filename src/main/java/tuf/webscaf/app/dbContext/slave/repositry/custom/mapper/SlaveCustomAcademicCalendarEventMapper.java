...
public class SlaveCustomAcademicCalendarEventMapper implements BiFunction<Row, Object, SlaveAcademicCalendarEventEntity> {
    @Override
    public SlaveAcademicCalendarEventEntity apply(Row source, Object o) {
        return SlaveAcademicCalendarEventEntity.builder()
                ...
                .academicCalendarEventTypeUUID(source.get("academic_calendar_event_type_uuid", UUID.class))
