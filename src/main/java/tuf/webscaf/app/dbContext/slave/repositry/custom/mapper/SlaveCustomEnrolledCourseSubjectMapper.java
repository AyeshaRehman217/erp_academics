...
public class SlaveCustomEnrolledCourseSubjectMapper implements BiFunction<Row, Object, SlaveEnrolledCourseSubjectDto> {
    @Override
    public SlaveEnrolledCourseSubjectDto apply(Row source, Object o) {
        return SlaveEnrolledCourseSubjectDto.builder()
