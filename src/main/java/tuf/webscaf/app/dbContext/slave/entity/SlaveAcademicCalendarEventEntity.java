...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"academic_calendar_events\"")
public class SlaveAcademicCalendarEventEntity {
    ...
    @Column("academic_calendar_event_type_uuid")
    private UUID academicCalendarEventTypeUUID;
