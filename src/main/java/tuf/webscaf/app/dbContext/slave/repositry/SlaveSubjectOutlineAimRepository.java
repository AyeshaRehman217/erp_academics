...
@Repository
public interface SlaveSubjectOutlineAimRepository extends ReactiveCrudRepository<SlaveSubjectOutlineAimEntity, Long> {
    /**
     * Fetch and Count All Records and Filter based on name and description only
     **/
    Flux<SlaveSubjectOutlineAimEntity> findAllByNameContainingIgnoreCaseAndDeletedAtIsNullOrDescriptionContainingIgnoreCaseAndDeletedAtIsNull(Pageable pageable, String name, String description);
     ...
     **/
    Flux<SlaveSubjectOutlineAimEntity> findAllByNameContainingIgnoreCaseAndStatusAndDeletedAtIsNullOrDescriptionContainingIgnoreCaseAndStatusAndDeletedAtIsNull(Pageable pageable, String name, Boolean status, String description, Boolean status1);
     ...
     **/
    Flux<SlaveSubjectOutlineAimEntity> findAllByNameContainingIgnoreCaseAndStatusAndSubjectOutlineUUIDAndDeletedAtIsNullOrDescriptionContainingIgnoreCaseAndStatusAndSubjectOutlineUUIDAndDeletedAtIsNull(Pageable pageable, String name, Boolean status, UUID subjectOutlineUUID, String description, Boolean status1, UUID subjectOutlineUUID1);
     ...
     **/
    Flux<SlaveSubjectOutlineAimEntity> findAllByNameContainingIgnoreCaseAndSubjectOutlineUUIDAndDeletedAtIsNullOrDescriptionContainingIgnoreCaseAndSubjectOutlineUUIDAndDeletedAtIsNull(Pageable pageable, String name, UUID subjectOutlineUUID, String description, UUID subjectOutlineUUID1);
    ...
    Mono<SlaveSubjectOutlineAimEntity> findByIdAndDeletedAtIsNull(Long id);

    Mono<SlaveSubjectOutlineAimEntity> findByUuidAndDeletedAtIsNull(UUID uuid);
