...
public class SlaveCustomStudentGuardianStudentGuardianProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentGuardianStudentGuardianProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentGuardianContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentGuardianStudentGuardianProfileContactNoFacadeDto apply(Row source, Object o) {

        SlaveStudentContactNoFacadeDto studentContactNoDto = null;

        try {
            studentContactNoDto = SlaveStudentContactNoFacadeDto.builder()
        ...
        String studentMetaUuid = source.get("studentMetaUUID", String.class);

        if (studentMetaUuid != null) {
            studentGuardianContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentGuardianStudentGuardianProfileContactNoFacadeDto.builder()
                ...
                .guardianTypeUUID(source.get("guardian_type_uuid", UUID.class))
                .guardianUUID(source.get("guardian_uuid", UUID.class))
                .studentGuardianUUID(source.get("studentGuardianUUID", UUID.class))
                .noOfDependents(source.get("noOfDependent", Integer.class))
                ...
                .genderUUID(source.get("gender", UUID.class))
                ...
                .studentGuardianContactNoDto(studentGuardianContactNoDtoMultiValueMap.get(studentMetaUuid))
