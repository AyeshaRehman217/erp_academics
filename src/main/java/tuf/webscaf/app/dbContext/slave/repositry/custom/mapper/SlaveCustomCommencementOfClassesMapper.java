...
public class SlaveCustomCommencementOfClassesMapper implements BiFunction<Row, Object, SlaveCommencementOfClassesDto> {
    @Override
    public SlaveCommencementOfClassesDto apply(Row source, Object o) {

        return SlaveCommencementOfClassesDto
                .builder()
                ...
                .rescheduledDate(source.get("rescheduled_date", LocalDateTime.class))
