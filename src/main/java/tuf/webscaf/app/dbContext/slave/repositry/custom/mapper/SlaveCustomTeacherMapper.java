...
public class SlaveCustomTeacherMapper implements BiFunction<Row, Object, SlaveTeacherDto> {
    @Override
    public SlaveTeacherDto apply(Row source, Object o) {

        return SlaveTeacherDto.builder()
                ...
                .employeeCode(source.get("employee_code", String.class))
                .campusUUID(source.get("campus_uuid", UUID.class))
                .deptRankUUID(source.get("dept_rank_uuid", UUID.class))
                .reportingTo(source.get("teacher_uuid", UUID.class))
