...
public class SlaveCustomPloMapper implements BiFunction<Row, Object, SlavePloEntity> {
    @Override
    public SlavePloEntity apply(Row source, Object o) {
        return SlavePloEntity.builder()
