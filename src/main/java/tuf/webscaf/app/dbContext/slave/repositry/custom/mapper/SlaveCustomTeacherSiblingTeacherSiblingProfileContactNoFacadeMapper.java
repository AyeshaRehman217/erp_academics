...
public class SlaveCustomTeacherSiblingTeacherSiblingProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherSiblingTeacherSiblingProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> teacherSiblingContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherSiblingTeacherSiblingProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (teacherMetaUuid != null) {
            teacherSiblingContactNoDtoMultiValueMap.add(teacherMetaUuid, teacherContactNoDto);
        }

        return SlaveTeacherSiblingTeacherSiblingProfileContactNoFacadeDto.builder()
                ...
                .teacherSiblingUUID(source.get("teacherSiblingUUID", UUID.class))
                ...
                .teacherSiblingContactNoDto(teacherSiblingContactNoDtoMultiValueMap.get(teacherMetaUuid))
