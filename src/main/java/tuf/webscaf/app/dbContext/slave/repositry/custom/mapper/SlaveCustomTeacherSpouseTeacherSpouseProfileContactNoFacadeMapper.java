...
public class SlaveCustomTeacherSpouseTeacherSpouseProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherSpouseTeacherSpouseProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> teacherSpouseContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherSpouseTeacherSpouseProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (teacherMetaUuid != null) {
            teacherSpouseContactNoDtoMultiValueMap.add(teacherMetaUuid, teacherContactNoDto);
        }

        return SlaveTeacherSpouseTeacherSpouseProfileContactNoFacadeDto.builder()
                ...
                .teacherSpouseUUID(source.get("teacherSpouseUUID", UUID.class))
                .teacherSpouseAsTeacherUUID(source.get("teacher_spouse_uuid", UUID.class))
                .teacherSpouseAsTeacherUUID(source.get("teacher_uuid", UUID.class))
                ...
                .teacherSpouseContactNoDto(teacherSpouseContactNoDtoMultiValueMap.get(teacherMetaUuid))
