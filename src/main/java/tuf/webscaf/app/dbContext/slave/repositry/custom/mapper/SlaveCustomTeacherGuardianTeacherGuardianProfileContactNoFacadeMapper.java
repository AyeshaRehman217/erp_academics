...
public class SlaveCustomTeacherGuardianTeacherGuardianProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherGuardianTeacherGuardianProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> teacherGuardianContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherGuardianTeacherGuardianProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (teacherMetaUuid != null) {
            teacherGuardianContactNoDtoMultiValueMap.add(teacherMetaUuid, teacherContactNoDto);
        }

        return SlaveTeacherGuardianTeacherGuardianProfileContactNoFacadeDto.builder()
                ...
                .teacherGuardianUUID(source.get("teacherGuardianUUID", UUID.class))
                .noOfDependents(source.get("noOfDependent", Integer.class))
                .image(source.get("image", UUID.class))
                .relation(source.get("relation", String.class))
                ...
                .teacherGuardianContactNoDto(teacherGuardianContactNoDtoMultiValueMap.get(teacherMetaUuid))
