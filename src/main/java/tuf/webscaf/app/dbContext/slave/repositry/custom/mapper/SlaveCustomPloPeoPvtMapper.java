...
public class SlaveCustomPloPeoPvtMapper implements BiFunction<Row, Object, SlavePloPeoPvtDto> {
    @Override
    public SlavePloPeoPvtDto apply(Row source, Object o) {
        return SlavePloPeoPvtDto.builder()
                ...
                .peoUUID(source.get("peo_uuid", UUID.class))
