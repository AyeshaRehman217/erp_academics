...
public class SlaveCustomCampusDepartmentMapper implements BiFunction<Row, Object, SlaveCampusDepartmentDto> {
    @Override
    public SlaveCampusDepartmentDto apply(Row source, Object o) {
        return SlaveCampusDepartmentDto.builder()
