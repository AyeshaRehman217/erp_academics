...
public class SlaveCustomStudentFatherStudentFatherProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentFatherStudentFatherProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentFatherContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentFatherStudentFatherProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (studentMetaUuid != null) {
            studentFatherContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentFatherStudentFatherProfileContactNoFacadeDto.builder()
                ...
                .studentFatherUUID(source.get("studentFatherUUID", UUID.class))
                ...
                .noOfDependents(source.get("noOfDependents", Integer.class))
                .studentFatherContactNoDto(studentFatherContactNoDtoMultiValueMap.get(studentMetaUuid))
