...
public class SlaveCustomStudentSpouseStudentSpouseProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentSpouseStudentSpouseProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentSpouseContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentSpouseStudentSpouseProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (studentMetaUuid != null) {
            studentSpouseContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentSpouseStudentSpouseProfileContactNoFacadeDto.builder()
                ...
                .studentSpouseUUID(source.get("studentSpouseUUID", UUID.class))
                .studentSpouseAsStudentUUID(source.get("student_spouse_uuid", UUID.class))
                .studentSpouseAsTeacherUUID(source.get("teacher_uuid", UUID.class))
                ...
                .studentSpouseContactNoDto(studentSpouseContactNoDtoMultiValueMap.get(studentMetaUuid))
