...
public class SlaveCustomSemesterMapper implements BiFunction<Row, Object, SlaveSemesterEntity> {
    @Override
    public SlaveSemesterEntity apply(Row source, Object o) {
        return SlaveSemesterEntity.builder()
                ...
                .semesterNo(source.get("semester_no", String.class))
