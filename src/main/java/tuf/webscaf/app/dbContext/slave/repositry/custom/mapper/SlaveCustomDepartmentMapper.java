...
public class SlaveCustomDepartmentMapper implements BiFunction<Row, Object, SlaveDepartmentEntity> {
    @Override
    public SlaveDepartmentEntity apply(Row source, Object o) {
        return SlaveDepartmentEntity.builder()
                ...
                .facultyUUID(source.get("faculty_uuid", UUID.class))
