...
public class SlaveCustomStudentSiblingStudentSiblingProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentSiblingStudentSiblingProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentSiblingContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentSiblingStudentSiblingProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (studentMetaUuid != null) {
            studentSiblingContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentSiblingStudentSiblingProfileContactNoFacadeDto.builder()
                ...
                .studentSiblingUUID(source.get("studentSiblingUUID", UUID.class))
                ...
                .studentSiblingContactNoDto(studentSiblingContactNoDtoMultiValueMap.get(studentMetaUuid))
