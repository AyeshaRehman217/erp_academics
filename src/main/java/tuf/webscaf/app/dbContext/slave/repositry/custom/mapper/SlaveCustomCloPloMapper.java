...
public class SlaveCustomCloPloMapper implements BiFunction<Row, Object, SlaveCloPloDto> {
    @Override
    public SlaveCloPloDto apply(Row source, Object o) {
        return SlaveCloPloDto.builder()
                ...
                .cloUUID(source.get("clo_uuid", UUID.class))
                .ploUUID(source.get("plo_uuid", UUID.class))
                .bloomTaxonomyUUID(source.get("bloom_taxonomy_uuid", UUID.class))
                .subLearningTypeUUID(source.get("sub_learning_type_uuid", UUID.class))
