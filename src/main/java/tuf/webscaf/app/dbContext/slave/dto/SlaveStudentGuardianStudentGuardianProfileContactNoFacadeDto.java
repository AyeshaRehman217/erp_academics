...
@NoArgsConstructor
@AllArgsConstructor
public class SlaveStudentGuardianStudentGuardianProfileContactNoFacadeDto {
    ...
    private UUID studentGuardianUUID;
    ...
    private List<SlaveStudentContactNoFacadeDto> studentGuardianContactNoDto;
