...
public class SlaveCustomTimetableCreationRepositoryImpl implements SlaveCustomTimetableCreationRepository {
    private DatabaseClient client;
    private SlaveTimetableCreationDto slaveTimetableCreationDto;

    @Autowired
    public SlaveCustomTimetableCreationRepositoryImpl(@Qualifier("slave") ConnectionFactory cf) {
