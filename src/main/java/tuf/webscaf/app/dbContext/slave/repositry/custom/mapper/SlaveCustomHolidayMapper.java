...
public class SlaveCustomHolidayMapper implements BiFunction<Row, Object, SlaveHolidayEntity> {
    @Override
    public SlaveHolidayEntity apply(Row source, Object o) {
        return SlaveHolidayEntity.builder()
                ...
                .holidayTypeUUID(source.get("holiday_type_uuid", UUID.class))
