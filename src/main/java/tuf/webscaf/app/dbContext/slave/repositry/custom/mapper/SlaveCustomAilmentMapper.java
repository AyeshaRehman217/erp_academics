...
public class SlaveCustomAilmentMapper implements BiFunction<Row, Object, SlaveAilmentEntity> {
    @Override
    public SlaveAilmentEntity apply(Row source, Object o) {
        return SlaveAilmentEntity.builder()
