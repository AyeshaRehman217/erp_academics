...
@NoArgsConstructor
@AllArgsConstructor
public class SlaveStudentFatherStudentFatherProfileContactNoFacadeDto {
    ...
    @Schema(hidden = true)
    private UUID studentFatherUUID;
    ...
    @Schema(required = true)
    private List<SlaveStudentContactNoFacadeDto> studentFatherContactNoDto;
