...
public class SlaveCustomAcademicSessionMapper implements BiFunction<Row, Object, SlaveAcademicSessionEntity> {
    @Override
    public SlaveAcademicSessionEntity apply(Row source, Object o) {
        return SlaveAcademicSessionEntity.builder()
                ...
                .academicYear(source.get("year", LocalDateTime.class))
                .startDate(source.get("start_date", LocalDateTime.class))
                .endDate(source.get("end_date", LocalDateTime.class))
                .sessionTypeUUID(source.get("session_type_uuid", UUID.class))
                .isOpen(source.get("is_open", Boolean.class))
                .isRegistrationOpen(source.get("is_registration_open", Boolean.class))
                .isEnrollmentOpen(source.get("is_enrollment_open", Boolean.class))
                .isTimetableAllow(source.get("is_timetable_allow", Boolean.class))
