...
public class SlaveCustomDepartmentRankCatalogueMapper implements BiFunction<Row, Object, SlaveDepartmentRankCatalogueEntity> {
    @Override
    public SlaveDepartmentRankCatalogueEntity apply(Row source, Object o) {
        return SlaveDepartmentRankCatalogueEntity.builder()
