...
public class SlaveCustomCourseOfferedMapper implements BiFunction<Row, Object, SlaveCourseOfferedDto> {
    @Override
    public SlaveCourseOfferedDto apply(Row source, Object o) {
        return SlaveCourseOfferedDto.builder()
                ...
                .campusCourseUUID(source.get("campus_course_uuid", UUID.class))
