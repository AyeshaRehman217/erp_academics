...
public class SlaveCustomSubjectMapper implements BiFunction<Row, Object, SlaveSubjectEntity> {
    @Override
    public SlaveSubjectEntity apply(Row source, Object o) {
        return SlaveSubjectEntity.builder()
