...
public class SlaveCustomDepartmentVisionAndMissionMapper implements BiFunction<Row, Object, SlaveDepartmentVisionAndMissionDto> {
    @Override
    public SlaveDepartmentVisionAndMissionDto apply(Row source, Object o) {
        return SlaveDepartmentVisionAndMissionDto.builder()
