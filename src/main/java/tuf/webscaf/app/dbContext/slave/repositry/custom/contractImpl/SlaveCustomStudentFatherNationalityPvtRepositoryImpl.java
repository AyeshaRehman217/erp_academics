...
public class SlaveCustomStudentFatherNationalityPvtRepositoryImpl implements SlaveCustomStudentFatherNationalityPvtRepository {
    private DatabaseClient client;
    private SlaveNationalityEntity slaveNationalityEntity;

    @Autowired
    public SlaveCustomStudentFatherNationalityPvtRepositoryImpl(@Qualifier("slave") ConnectionFactory cf) {
        this.client = DatabaseClient.create(cf);
    }

    @Override
    public Flux<SlaveNationalityEntity> existingNationalityList(UUID studentFatherUUID, String name, String description, String dp, String d, Integer size, Long page) {
    ...
    @Override
    public Flux<SlaveNationalityEntity> existingStudentFatherNationalitiesListWithStatus(UUID studentFatherUUID, String name, String description, Boolean status, String dp, String d, Integer size, Long page) {
        String query = "SELECT nationalities.* FROM nationalities\n" +
                "WHERE nationalities.uuid NOT IN(\n" +
                "SELECT nationalities.uuid FROM nationalities\n" +
                "LEFT JOIN std_fth_nationalities_pvt\n" +
    ...
    @Override
    public Flux<SlaveNationalityEntity> showStudentFatherNationalitiesList(UUID studentFatherUUID, String name, String description, String dp, String d, Integer size, Long page) {
        String query = "select nationalities.* from nationalities\n" +
                "left join std_fth_nationalities_pvt \n" +
    ...
    @Override
    public Flux<SlaveNationalityEntity> showStudentFatherNationalitiesListWithStatus(UUID studentFatherUUID, Boolean status, String name, String description, String dp, String d, Integer size, Long page) {
        String query = "select nationalities.* from nationalities\n" +
                "left join std_fth_nationalities_pvt \n" +
                "on nationalities.uuid = std_fth_nationalities_pvt.nationality_uuid\n" +
                "where std_fth_nationalities_pvt.std_father_uuid = '" + studentFatherUUID +
