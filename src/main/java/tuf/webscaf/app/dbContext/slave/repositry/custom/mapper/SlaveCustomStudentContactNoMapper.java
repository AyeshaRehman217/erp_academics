...
public class SlaveCustomStudentContactNoMapper implements BiFunction<Row, Object, SlaveStudentContactNoDto> {
    @Override
    public SlaveStudentContactNoDto apply(Row source, Object o) {

        return SlaveStudentContactNoDto
                .builder()
                ...
                .studentMetaUUID(source.get("student_meta_uuid", UUID.class))
                .contactTypeUUID(source.get("contact_type_uuid", UUID.class))
                .contactCategoryUUID(source.get("contact_category_uuid", UUID.class))
