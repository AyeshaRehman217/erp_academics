...
public class SlaveCustomStudentFatherProfileMapper implements BiFunction<Row, Object, SlaveStudentFatherProfileEntity> {
    @Override
    public SlaveStudentFatherProfileEntity apply(Row source, Object o) {

        return SlaveStudentFatherProfileEntity.builder()
                ...
                .studentFatherUUID(source.get("std_father_uuid", UUID.class))
                ...
                .officialTel(source.get("official_tel", String.class))
                .age(source.get("age", Integer.class))
                .noOfDependents(source.get("no_of_dependents", Integer.class))
                .countryUUID(source.get("country_uuid", UUID.class))
                .cityUUID(source.get("city_uuid", UUID.class))
                .stateUUID(source.get("state_uuid", UUID.class))
