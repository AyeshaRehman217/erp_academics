...
public class SlaveCustomPeoDtoMapper implements BiFunction<Row, Object, SlavePeoDto> {
    @Override
    public SlavePeoDto apply(Row source, Object o) {
        return SlavePeoDto.builder()
