...
public class SlaveCustomNationalityMapper implements BiFunction<Row, Object, SlaveNationalityEntity> {
    @Override
    public SlaveNationalityEntity apply(Row source, Object o) {
        return SlaveNationalityEntity.builder()
