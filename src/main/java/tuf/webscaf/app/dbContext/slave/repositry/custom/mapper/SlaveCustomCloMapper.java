...
public class SlaveCustomCloMapper implements BiFunction<Row, Object, SlaveCloEntity> {
    @Override
    public SlaveCloEntity apply(Row source, Object o) {
        return SlaveCloEntity.builder()
                ...
                .emphasisUUID(source.get("emphasis_uuid", UUID.class))
