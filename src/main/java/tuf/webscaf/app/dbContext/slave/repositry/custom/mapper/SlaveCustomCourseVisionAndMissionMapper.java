...
public class SlaveCustomCourseVisionAndMissionMapper implements BiFunction<Row, Object, SlaveCourseVisionAndMissionEntity> {
    @Override
    public SlaveCourseVisionAndMissionEntity apply(Row source, Object o) {
        return SlaveCourseVisionAndMissionEntity.builder()
                ...
                .vision(source.get("vision", String.class))
                .mission(source.get("mission", String.class))
                .objectives(source.get("objectives", String.class))
                .outcomes(source.get("outcomes", String.class))
