...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"clo_plos\"")
public class SlaveCloPloEntity {
    ...
    @Column("clo_uuid")
    private UUID cloUUID;

    @Column("plo_uuid")
    private UUID ploUUID;

    @Column("bloom_taxonomy_uuid")
    private UUID bloomTaxonomyUUID;

    @Column("sub_learning_type_uuid")
    private UUID subLearningTypeUUID;
