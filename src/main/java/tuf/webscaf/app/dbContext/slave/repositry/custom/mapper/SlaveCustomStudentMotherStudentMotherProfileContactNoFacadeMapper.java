...
public class SlaveCustomStudentMotherStudentMotherProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentMotherStudentMotherProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentMotherContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentMotherStudentMotherProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (studentMetaUuid != null) {
            studentMotherContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentMotherStudentMotherProfileContactNoFacadeDto.builder()
                ...
                .studentMotherUUID(source.get("studentMotherUUID", UUID.class))
                ...
                .studentContactNoDto(studentMotherContactNoDtoMultiValueMap.get(studentMetaUuid))
