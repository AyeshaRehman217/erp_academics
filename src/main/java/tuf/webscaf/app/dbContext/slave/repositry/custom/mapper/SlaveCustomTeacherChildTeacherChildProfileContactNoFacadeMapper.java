...
public class SlaveCustomTeacherChildTeacherChildProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherChildTeacherChildProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> teacherChildContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherChildTeacherChildProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        String teacherMetaUuid = source.get("stdMetaUUID", String.class);

        if (teacherMetaUuid != null) {
            teacherChildContactNoDtoMultiValueMap.add(teacherMetaUuid, teacherContactNoDto);
        }

        return SlaveTeacherChildTeacherChildProfileContactNoFacadeDto.builder()
                ...
                .teacherChildUUID(source.get("teacherChildUUID", UUID.class))
                ...
                .teacherChildContactNoDto(teacherChildContactNoDtoMultiValueMap.get(teacherMetaUuid))
