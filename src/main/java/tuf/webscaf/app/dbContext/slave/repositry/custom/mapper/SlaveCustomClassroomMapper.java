...
public class SlaveCustomClassroomMapper implements BiFunction<Row, Object, SlaveClassroomDto> {
    @Override
    public SlaveClassroomDto apply(Row source, Object o) {

        return SlaveClassroomDto
                .builder()
                ...
                .capacity(source.get("capacity", Integer.class))
