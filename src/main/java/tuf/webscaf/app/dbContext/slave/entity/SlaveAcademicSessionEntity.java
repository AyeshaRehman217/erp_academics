...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"academic_sessions\"")
public class SlaveAcademicSessionEntity {
    ...
    @Column("year")
    private LocalDateTime academicYear;
    ...
    @Column("is_enrollment_open")
    private Boolean isEnrollmentOpen;

    @Column("is_timetable_allow")
    @Schema(hidden = true)
