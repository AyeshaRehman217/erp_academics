...
public class SlaveCustomCourseDtoMapper implements BiFunction<Row, Object, SlaveCourseDto> {
    @Override
    public SlaveCourseDto apply(Row source, Object o) {
        return SlaveCourseDto.builder()
