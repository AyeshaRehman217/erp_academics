...
public class SlaveCustomSubjectOfferedMapper implements BiFunction<Row, Object, SlaveSubjectOfferedDto> {
    @Override
    public SlaveSubjectOfferedDto apply(Row source, Object o) {
        return SlaveSubjectOfferedDto.builder()
