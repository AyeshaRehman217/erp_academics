...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"teacher_contact_nos\"")
public class SlaveTeacherContactNoEntity {
    ...
    @Column("teacher_meta_uuid")
    private UUID teacherMetaUUID;

    @Column("contact_type_uuid")
    private UUID contactTypeUUID;

    @Column("contact_category_uuid")
    private UUID contactCategoryUUID;
