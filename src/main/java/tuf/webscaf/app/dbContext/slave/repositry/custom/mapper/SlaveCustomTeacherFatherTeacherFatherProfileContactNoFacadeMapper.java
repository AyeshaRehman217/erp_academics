...
public class SlaveCustomTeacherFatherTeacherFatherProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherFatherTeacherFatherProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> teacherFatherContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherFatherTeacherFatherProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (teacherMetaUuid != null) {
            teacherFatherContactNoDtoMultiValueMap.add(teacherMetaUuid, teacherContactNoDto);
        }

        return SlaveTeacherFatherTeacherFatherProfileContactNoFacadeDto.builder()
                ...
                .teacherFatherUUID(source.get("teacherFatherUUID", UUID.class))
                ...
                .teacherFatherContactNoDto(teacherFatherContactNoDtoMultiValueMap.get(teacherMetaUuid))
