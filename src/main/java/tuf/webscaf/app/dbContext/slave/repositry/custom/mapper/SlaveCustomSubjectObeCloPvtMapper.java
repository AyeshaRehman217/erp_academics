...
public class SlaveCustomSubjectObeCloPvtMapper implements BiFunction<Row, Object, SlaveSubjectObeCloPvtDto> {
    @Override
    public SlaveSubjectObeCloPvtDto apply(Row source, Object o) {
        return SlaveSubjectObeCloPvtDto.builder()
                ...
                .subjectObeUUID(source.get("subject_obe_uuid", UUID.class))
