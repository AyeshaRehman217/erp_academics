...
public class SlaveCustomStudentRegisteredCourseMapper implements BiFunction<Row, Object, SlaveStudentRegisteredCourseDto> {
    @Override
    public SlaveStudentRegisteredCourseDto apply(Row source, Object o) {
        return SlaveStudentRegisteredCourseDto.builder()
                ...
                .courseOffered(source.get("courseOffered", UUID.class))
