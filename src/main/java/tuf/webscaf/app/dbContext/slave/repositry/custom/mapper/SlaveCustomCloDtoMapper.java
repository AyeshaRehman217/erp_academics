...
public class SlaveCustomCloDtoMapper implements BiFunction<Row, Object, SlaveCloDto> {
    @Override
    public SlaveCloDto apply(Row source, Object o) {
        return SlaveCloDto.builder()
