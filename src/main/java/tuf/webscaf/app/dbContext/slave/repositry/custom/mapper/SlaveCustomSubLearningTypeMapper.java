...
public class SlaveCustomSubLearningTypeMapper implements BiFunction<Row, Object, SlaveSubLearningTypeEntity> {
    @Override
    public SlaveSubLearningTypeEntity apply(Row source, Object o) {
        return SlaveSubLearningTypeEntity.builder()
