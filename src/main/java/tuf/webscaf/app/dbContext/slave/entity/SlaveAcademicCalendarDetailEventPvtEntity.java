...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"academic_calendar_detail_events_pvt\"")
public class SlaveAcademicCalendarDetailEventPvtEntity {
    ...
    @Column("academic_calendar_detail_uuid")
    private UUID academicCalendarDetailUUID;

    @Column("academic_calendar_event_uuid")
    private UUID academicCalendarEventUUID;
