...
public class SlaveCustomTeacherContactNoMapper implements BiFunction<Row, Object, SlaveTeacherContactNoDto> {
    @Override
    public SlaveTeacherContactNoDto apply(Row source, Object o) {

        return SlaveTeacherContactNoDto
                .builder()
                ...
                .teacherMetaUUID(source.get("teacher_meta_uuid", UUID.class))
