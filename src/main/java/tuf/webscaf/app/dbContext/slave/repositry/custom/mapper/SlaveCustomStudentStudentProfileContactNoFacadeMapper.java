...
public class SlaveCustomStudentStudentProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveStudentStudentProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveStudentContactNoFacadeDto> studentContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveStudentStudentProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (studentMetaUuid != null) {
            studentContactNoDtoMultiValueMap.add(studentMetaUuid, studentContactNoDto);
        }

        return SlaveStudentStudentProfileContactNoFacadeDto.builder()
                ...
                .studentContactNoDto(studentContactNoDtoMultiValueMap.get(studentMetaUuid))
