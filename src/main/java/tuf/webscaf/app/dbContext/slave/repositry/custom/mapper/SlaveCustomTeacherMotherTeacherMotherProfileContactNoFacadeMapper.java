...
public class SlaveCustomTeacherMotherTeacherMotherProfileContactNoFacadeMapper implements BiFunction<Row, Object, SlaveTeacherMotherTeacherMotherProfileContactNoFacadeDto> {

    MultiValueMap<String, SlaveTeacherContactNoFacadeDto> TeacherMotherContactNoDtoMultiValueMap = new LinkedMultiValueMap<>();

    @Override
    public SlaveTeacherMotherTeacherMotherProfileContactNoFacadeDto apply(Row source, Object o) {
        ...
        if (teacherMetaUUID != null) {
            TeacherMotherContactNoDtoMultiValueMap.add(teacherMetaUUID, TeacherContactNoDto);
        }

        return SlaveTeacherMotherTeacherMotherProfileContactNoFacadeDto.builder()
                ...
                .teacherMotherUUID(source.get("teacherMotherUUID", UUID.class))
                ...
                .teacherContactNoDto(TeacherMotherContactNoDtoMultiValueMap.get(teacherMetaUUID))
